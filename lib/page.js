    ...
    injectJs: function(content, pageRes) {
        ...
        if (conf.autoPack) {
            Object.keys(pkg).forEach(function(pId) {
                ...
                if (!pFile.isAsync && pFile.isJsLike && pFile.sourceHtml === self.file.subpath) {
    ...
    generateSourceMap: function(analysis) {
        ...
        if (conf.autoPack) {
            Object.keys(analysis.depMap).forEach(function(p, index) {
                ...
                if (!ret.ids[p].isJsLike || !analysis.depMap[p].isAsync) {
                    return;
                }
            ...
            Object.keys(analysis.pageRes).forEach(function(depId) {
                var file = ret.ids[depId];
                if (!file.isJsLike || !analysis.pageRes[depId].isAsync) {
                    return;
                }
