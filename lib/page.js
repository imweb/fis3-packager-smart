...
_.assign(module.exports.prototype, {
    init: function() {
        ...
        // console.log(Object.keys(analysis.cssDeps));
    ...
    analyzeHtmlDepsAndAsync: function() {
        ...
        // TODO： conf.lib 指定的模块名和这里的fileId不一致，fileId指向的lego中对应版本的模块
    ...
    calFileDepsFromId: function(file, pageRes) {
        ...
        // console.log(Object.keys(cssDeps));
        return {
            deps: deps,
            cssDeps: cssDeps,
            asyncDeps: asyncDeps
    ...
    modJsCodeGen: function(map) {
        ...
        //     copy.res[newKey] = {};
        //     copy.res[newKey].pkg = res[key].pkg;
        //     if (res[key].deps) {
        //         copy.res[newKey].deps = res[key].deps.concat([]);
        //         copy.res[newKey].deps.forEach(function(dep, index) {
        //             copy.res[newKey].deps[index] = dep.replace(/\.js$/, '')
        //         });
        //     }
        // }

        // for(var p in map.pkg) {
        //     copy.pkg[p] = {
        //         url: map.pkg[p].url
        //     };
        // }
